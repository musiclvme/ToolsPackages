...
static int circle_init = 0;
static complex_t icircle[MAX_FFT_LEN/2];
static int icircle_init = 0;
...
/*- End of function --------------------------------------------------------*/
void * sf_open_telephony_read(const char *name, int channels, void **filefd)
{
    SNDFILE *handle;
    SF_INFO info;
	...
	*filefd = handle;
	printf("sf_open_telephony_read: handle=0x%p\n", handle);
    return (void *)handle;
}
/*- End of function --------------------------------------------------------*/

void * sf_open_telephony_write(const char *name, int channels, void **filefd)
{
    SNDFILE *handle;
    SF_INFO info;
	...
	*filefd = handle;
	printf("sf_open_telephony_write: handle=%p\n", handle);
	//printf("sf_open_telephony_write: test=0x%lx\n", test);
    return handle;
}
/*- End of function --------------------------------------------------------*/
/*- End of file ------------------------------------------------------------*/
